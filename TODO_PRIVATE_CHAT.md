...
|--------|----------|-------------|
| GET | `/api/private-chat/search?q=...` | Search users by name/email to start a conversation |
...
## Search Feature
- Click the **search icon** (magnifying glass) in the conversations sidebar
- Type a name or email to search for any user
- Click a search result to instantly start a conversation
